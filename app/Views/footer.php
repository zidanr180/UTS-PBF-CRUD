  ...
  <footer class="py-5 bg-gray-700 flex flex-col">
    <div class="flex flex-row justify-center justify-items-center mt-6 mb-4">
      ...
      <a class="my-auto mx-5 text-lg text-white font-medium">CRUD Buku</a>
    </div>
    ...
    <div class="flex xl:flex-row lg:flex-row md:flex-row flex-col xl:my-auto lg:my-auto md:my-auto justify-evenly">
      ...
      <div class="max-w-72 m-auto">
        ...
        <p class="text-white text-center">123456789101</p>
      </div>
      ...
      <div class="max-w-72 m-auto ">
        ...
        <p class="text-white text-center">Surabaya, Jawa Timur</p>
      </div>
    </div>
    <p class="mt-16 mb-3 mx-10 py-5 border-t border-white text-center text-white">&copy; Waroeng Kopi 2024</p>
  </footer>
